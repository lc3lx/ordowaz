...
export default function HomePage() {
  ...
  const services = [
    {
      ...
      description: "دعم شامل في إعداد وكتابة الرسائل الأكاديمية بأعلى معايير الجودة العلمية والأكاديمية",
      features: ["إعداد الخطة البحثية", "كتابة الفصول", "المراجعة النهائية"],
    },
    {
      icon: <FileText className="h-8 w-8" />,
      title: "إعادة الصياغة اللغوية والتدقيق اللغوي والإملائي",
      description: "خدمات التدقيق والمراجعة اللغوية المتخصصة باللغتين العربية والإنجليزية",
      features: ["تدقيق إملائي", "مراجعة نحوية", "تحسين الأسلوب"],
    },
    {
      icon: <Search className="h-8 w-8" />,
      title: "توفير الدراسات السابقة",
      description: "البحث المتخصص عن وتوفير الدراسات السابقة والمراجع العلمية المتعلقة بموضوع بحثك",
      features: ["بحث شامل", "مراجع حديثة", "تصنيف منهجي"],
    },
    {
      icon: <FileText className="h-8 w-8" />,
      title: "كتابة المحتوى البحثي",
      description: "إعداد وكتابة المحتوى البحثي المتخصص وفقاً للخطة البحثية والمعايير الأكاديمية",
      features: ["محتوى أصيل", "منهجية علمية", "مراجع موثقة"],
    },
    {
      icon: <BookOpen className="h-8 w-8" />,
      title: "كتابة مخطط البحث (البروبوزال)",
      description: "إعداد مخططات البحث الأكاديمية المتميزة باللغتين العربية والإنجليزية",
      features: ["خطة واضحة", "أهداف محددة", "منهجية مناسبة"],
    },
    {
      icon: <BarChart className="h-8 w-8" />,
      title: "التحليل الكمي والنوعي",
      description: "خدمات التحليل الإحصائي المتقدم والتحليل النوعي للبيانات البحثية باستخدام أحدث البرامج",
      features: ["SPSS", "تحليل إحصائي", "تفسير النتائج"],
    },
    {
      icon: <Shield className="h-8 w-8" />,
      title: "فحص الملفات (Turnitin) وفحص الذكاء الاصطناعي",
      description: "فحص شامل للأعمال البحثية للتأكد من الأصالة وعدم الانتحال باستخدام أحدث التقنيات",
      features: ["فحص Turnitin", "كشف AI", "تقرير مفصل"],
    },
    {
      icon: <Microscope className="h-8 w-8" />,
      title: "مشاريع التخرج الطبية والهندسية",
      description: "إعداد وتطوير مشاريع التخرج المتخصصة لكليات الطب والهندسة بمختلف التخصصات",
      features: ["تصميم تطبيقي", "بحث نظري", "عرض تقديمي"],
    },
    {
      icon: <Users className="h-8 w-8" />,
      title: "عمل أدوات الدراسة وبناء الأدوات البحثية",
      description: "تصميم وبناء أدوات البحث المتخصصة والاستبيانات العلمية وفق المعايير الأكاديمية",
      features: ["استبيانات", "مقاييس", "أدوات قياس"],
    },
    {
      icon: <Award className="h-8 w-8" />,
      title: "تفسير ومناقشة النتائج",
      description: "تحليل وتفسير نتائج البحوث العلمية بطريقة منهجية ودقيقة مع ربطها بالدراسات السابقة",
      features: ["تحليل عميق", "مناقشة علمية", "توصيات عملية"],
    },
    {
      icon: <Star className="h-8 w-8" />,
      title: "بحوث الترقية والمؤتمرات",
      description: "إعداد البحوث المتخصصة للترقيات الأكاديمية والمؤتمرات العلمية وفق أعلى المعايير",
      features: ["معايير عالمية", "جودة عالية", "مراجعة دقيقة"],
    },
    {
      icon: <Globe className="h-8 w-8" />,
      title: "النشر في المجلات العالمية المحكمة",
      description: "المساعدة الشاملة في نشر البحوث في المجلات العلمية المفهرسة في قواعد البيانات العالمية",
      features: ["مجلات Scopus", "مراجعة الأقران", "فهرسة عالمية"],
    },
    {
      icon: <Globe className="h-8 w-8" />,
      title: "تصميم وتطوير المواقع الإلكترونية",
      description: "تصميم وتطوير مواقع إلكترونية احترافية ومتجاوبة لعرض خدمات البحث العلمي والأكاديمي بأفضل شكل ممكن",
      features: ["تصميم متجاوب", "سرعة عالية", "محسن لمحركات البحث"],
    },
    {
      icon: <MessageCircle className="h-8 w-8" />,
      title: "تطوير تطبيقات الجوال",
      description: "تطوير تطبيقات جوال متقدمة لخدمات البحث العلمي والأكاديمي لنظامي iOS و Android",
      features: ["تطبيقات أصلية", "واجهة سهلة", "إشعارات فورية"],
    },
    {
      icon: <Microscope className="h-8 w-8" />,
      title: "حلول الذكاء الاصطناعي للبحث العلمي",
      description: "تطوير أدوات ذكاء اصطناعي متخصصة لتحليل البيانات البحثية وتسريع عملية البحث العلمي والأكاديمي",
  ...
  // استبدل مكون ContactForm بهذا الإصدار الذي يعمل بشكل فعلي
  const ContactForm = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
      ...
      try {
        ...
        setError("حدث خطأ في إرسال الرسالة. يرجى المحاولة مرة أخرى أو التواصل عبر واتساب.")
      } finally {
        ...
        <div className="container mx-auto text-center relative">
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-1000">
            ...
            <p className="text-xl md:text-2xl text-slate-700 mb-8 max-w-4xl mx-auto leading-relaxed">
              أردواز - نقدم خدمات شاملة ومتخصصة في مجال البحث العلمي والأكاديمي، تصميم المواقع، تطبيقات الجوال، والذكاء
              الاصطناعي بأعلى معايير الجودة والدقة
            </p>
          </div>
            ...
            {[
              {
                ...
                title: "جودة عالية",
                description: "نلتزم بأعلى معايير الجودة العالمية في جميع خدماتنا البحثية والأكاديمية",
              ...
              },
              {
                ...
                title: "فريق متخصص",
                description: "فريق من الخبراء والأكاديميين المتخصصين في مختلف المجالات العلمية",
              ...
              },
              {
                ...
                title: "سرية تامة",
                description: "نضمن الحفاظ على سرية وخصوصية جميع أعمالكم وبياناتكم البحثية",
              ...
              },
              {
                ...
                title: "دعم مستمر",
                description: "متاحون للتواصل والدعم الفني على مدار الساعة طوال أيام الأسبوع",
              ...
              >
                ...
                >
                  <div className={`bg-gradient-to-r ${item.color} bg-clip-text text-transparent`}>{item.icon}</div>
                </div>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 mb-6 max-w-2xl mx-auto">
              شريكك الموثوق في رحلة البحث العلمي والأكاديمي - نقدم خدمات متميزة بأعلى معايير الجودة
            </p>
          ...
          <div className="border-t border-slate-800 pt-8 text-center">
            <p className="text-sm text-slate-500">© 2024 أردواز لخدمات البحث العلمي. جميع الحقوق محفوظة.</p>
          </div>
        </div>
      </footer>
    </div>
